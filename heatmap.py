...
for cla_index in range(4):
    ...
    gg = np.load('/home/syh/Documents/MI/code/MI-GAN/generate_csp/gen_justT_test/S' + str(sub_index) +
                    '_class' + str(cla_index) + '.npy')
    gen_data.append(gg[0:750, :, :, :])
gen_data = np.load('/home/syh/Documents/MI/code/MI-GAN/generate_csp/gen_justT_test/S1_class' + str(cla_index) + '.npy')
...
plt.savefig('/home/syh/Pictures/test.png', dpi=3600)
plt.show()
