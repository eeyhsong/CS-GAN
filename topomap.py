...
gen_data = []
gen_data0 = np.load('/home/syh/Documents/MI/code/MI-GAN/generate_csp/gen_justT_test/S' + str(sub_index) + '_class0.npy')
gen_data0 = np.squeeze(gen_data0[0:250, :, :, :])
gen_data1 = np.load('/home/syh/Documents/MI/code/MI-GAN/generate_csp/gen_justT_test/S' + str(sub_index) + '_class1.npy')
gen_data1 = np.squeeze(gen_data1[0:750, :, :, :])
gen_data2 = np.load('/home/syh/Documents/MI/code/MI-GAN/generate_csp/gen_justT_test/S' + str(sub_index) + '_class2.npy')
gen_data2 = np.squeeze(gen_data2[0:250, :, :, :])
gen_data3 = np.load('/home/syh/Documents/MI/code/MI-GAN/generate_csp/gen_justT_test/S' + str(sub_index) + '_class3.npy')
...
plt.ylabel('C4')
plt.xlabel('Time (s)')
plt.savefig('/home/syh/Pictures/Fig5.png', dpi=600)
